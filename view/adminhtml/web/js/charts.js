define([
    ...
    function _prepareChartData(elementId, options){
        ...
        // var count = options.y.ticks.length - 1;
        // var minorCount = (10 - count) / count;

        // options.char
        options.chart.vAxis.ticks = options.y.ticks;
        // options.chart.vAxis.maxValue = options.y.max;
        // options.chart.vAxis.gridlines.count = options.y.ticks.length * 2;
